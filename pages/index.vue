            ...
            <div class="card-content">
              ...
              <div class="content">
                ...
                <p>
                  ...
                  <br />
                  その他、電子工作やWEBアプリケーションを作成したりなど幅広く扱っています。
                  <br />
                ...
                <ul>
                  <li>ネットワークスペシャリスト（2021年6月合格）</li>
                  <li>応用情報技術者（2020年12月合格）</li>
                  <li>第二種電気工事士免許（2021年1月取得）</li>
                </ul>
                <p class="subtitle">
                  スキルセット
                </p>
                ...
                <p>
                  上記リンクのTwitter DMよりよろしくお願いいたします。
                  <br />
                  知人であれば資格を生かして家庭内ネットワークや家庭内電気設備の相談に乗ることもできます。
                  <br />
                  Twin:teに関するお問い合わせは
                  <a href="https://www.twinte.net">こちら</a>
                  をご覧ください。
                </p>
              </div>
            </div>
