    ...
    data() {
      return {
        articles: [{
            ...
            description: '新メンバーを加えてリニューアル。主に4人で共同開発。インフラ・iOSアプリ担当。しかしアプリのほとんどはWebViewである。ウィジェット機能を有し、曜日振替に対応した今日の時間割が表示される。OSSなので長くメンテナンスされることを期待している。将来的には時間割アプリ以外の機能も追加する予定。',
            tag: ['Swift','Ubuntu']
          },
          {
            title: 'WEB版デンモク',
          ...
          },
          {
            ...
            description: '筑波大生専用の時間割アプリ。2人で共同開発。バックグラウンドを担当。Twin:te Projectの原点である。「簡単に・詳細で・見やすく・使いやすい」時間割を目標に制作。 しかしほとんどフロントエンドの機能なのである。',
            tag: ['PHP','Ubuntu']
          },
          {
            title: 'WEB版デンモク',
          ...
          },
          {
            ...
            description: '高校3年時の文化祭クラス企画。射撃の全てを自動化。入場者の得点ランキングを教室入り口の大型モニターで表示。サーバー（ノーパソ）を教室に半年間設置していた。燃えなくてよかった。',
          ...
          },
          {
            ...
            link: '',
            description: '高校2年時の文化祭クラス企画。迷宮で謎を解きつつ、点数を競う企画。入場者の得点ランキングが自動で専用HPに公開されるシステムを構築した。受付でiPadを用いて入退場を管理していたが、UIが悪くてヒューマンエラーが多発した。',
            tag: ['C#','ASP.NET']
          },
          {
            title: 'スクフェスボタン',
            ...
            description: 'スクフェスを物理ボタンでできるようにした。ただしPCのみ対応という謎仕様。PCのスクフェスシミュレーターで使用できる。なお、その後ジャンケンマシンとして再利用された。',
            tag: ['Arduino']
          },
          {
            title: 'クイズ効果音操作アプリ',
            ...
            description: '高校の文化祭の委員会開催であるクイズ大会の効果音を簡単に再生できるアプリ。イントロクイズもこれで簡単に出題できる。',
            tag: ['C#','フォームアプリ']
          },
          {
            ...
            description: '友人となんとなく応募。HPビルダーは甘えなのでしっかりコードを書いて応募した。なお敢闘賞。',
            tag: ['HTML','CSS','jQuery']
          }
        ],
        viewYear: 'all'
